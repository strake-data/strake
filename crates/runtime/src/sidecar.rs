...
//!
//! Manages the lifecycle of the Python sidecar process which hosts Model Context Protocol (MCP)
//! servers. Handles process spawning, graceful shutdown, and health monitoring.
